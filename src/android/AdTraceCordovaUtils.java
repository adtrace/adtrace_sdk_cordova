...
public class AdTraceCordovaUtils {
    ...
    public static Map<String, String> getAttributionMap(AdTraceAttribution attribution) {
    ...
    public static Map<String, String> getEventSuccessMap(AdTraceEventSuccess event) {
        Map<String, String> map = new HashMap<String, String>();
    ...
    public static Map<String, String> getEventFailureMap(AdTraceEventFailure event) {
        Map<String, String> map = new HashMap<String, String>();
        addValueOrEmpty(map, KEY_MESSAGE, event.message);
        addValueOrEmpty(map, KEY_TIMESTAMP, event.timestamp);
        addValueOrEmpty(map, KEY_ADID, event.adid);
    ...
    public static Map<String, String> getSessionSuccessMap(AdTraceSessionSuccess session) {
        Map<String, String> map = new HashMap<String, String>();
    ...
    public static Map<String, String> getSessionFailureMap(AdTraceSessionFailure session) {
        Map<String, String> map = new HashMap<String, String>();
        addValueOrEmpty(map, KEY_MESSAGE, session.message);
        addValueOrEmpty(map, KEY_TIMESTAMP, session.timestamp);
        addValueOrEmpty(map, KEY_ADID, session.adid);
