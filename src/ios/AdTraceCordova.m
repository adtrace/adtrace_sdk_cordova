...
- (void)create:(CDVInvokedUrlCommand *)command {
    ...
    if (isAttributionCallbackImplemented
        ...
        [adtraceConfig setDelegate:
            [AdTraceCordovaDelegate getInstanceWithSwizzleOfAttributionCallback:isAttributionCallbackImplemented
...
- (void)trackEvent:(CDVInvokedUrlCommand *)command {
    ...
    for (int i = 0; i < [callbackParameters count]; i += 2) {
        ...
        [adtraceEvent addCallbackParameter:key value:[NSString stringWithFormat:@"%@", value]];
    }
    ...
    for (int i = 0; i < [partnerParameters count]; i += 2) {
        ...
        [adtraceEvent addPartnerParameter:key value:[NSString stringWithFormat:@"%@", value]];
    }
...
- (void)setOfflineMode:(CDVInvokedUrlCommand *)command {
    ...
    [AdTrace setOfflineMode:[isEnabledNumber boolValue]];
}
...
- (void)setEnabled:(CDVInvokedUrlCommand *)command {
    ...
    [AdTrace setEnabled:[isEnabledNumber boolValue]];
}
...
- (void)teardown:(CDVInvokedUrlCommand *)command {
    ...
    sessionSucceededCallbackId = nil;
    deferredDeeplinkCallbackId = nil;
    [AdTraceCordovaDelegate teardown];
}
